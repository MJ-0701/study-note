...
/** subject-exam-prep route — slot placeholder. */
export function renderSubjectExamPrepSlot(): string {
  return `<div id="subject-exam-prep-island" data-react-island="subject-exam-prep" style="display:contents"></div>`;
}
