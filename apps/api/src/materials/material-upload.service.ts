// PDF 업로드 상태머신 전담 서비스 (DDD F-3: MaterialsService God Service 에서 intent→PUT→complete 업로드 책임 분리).
import {
  BadRequestException,
  ConflictException,
  Injectable,
...
import { PrismaService, toPdfMaterialRecord } from "@study-note/persistence";
...
export class MaterialUploadService {
  ...
  // DDD Slice 7: PdfMaterial query 는 repository 위임.
