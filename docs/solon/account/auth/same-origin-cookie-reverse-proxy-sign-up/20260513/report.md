...
handoff_dir: "docs/solon/account/auth/same-origin-cookie-reverse-proxy-sign-up/20260513"
...
- **남김 (durable)**: `docs/solon/account/auth/same-origin-cookie-reverse-proxy-sign-up/20260513/{retro,report}.md`
